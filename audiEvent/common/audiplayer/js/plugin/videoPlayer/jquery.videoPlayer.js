...
(function ($) {
    ...
    $.fn.videoPlayer = function (options) {
        ...
        return this.each(function () {
            ...
            controls_html += '<div class="timer_duration">00:00</div>';
            controls_html += '<div class="volume-box"><div class="volume-slider"></div>';
            controls_html += '<a accesskey="m" class="volume-btn" title="음소거/음소거_해제 (M)"></a> </div>';
            controls_html += '<div class="full-screen"></div></div>';
            ...
            function createSeek() {
                if (vp.readyState) {
                    var dur = vp.duration;
                    $timer_duration.text(timeFormat(dur));
                    $seek.slider({
                        step: 0.01,
                        range: 'min',
                        max: dur,
            ...
            function seekUpdate() {
                ...
                if (!seek_sliding)
                    $seek.slider('value', current_time);
            ...
            function toggleFullScreen() {
                ...
                if (!$(document).fullscreenElement && // alternative standard method
                    ...
                    if (vp.requestFullscreen) {
                        ...
                        vp.webkitRequestFullscreen(vp.ALLOW_KEYBOARD_INPUT);
                    }
                } else {
